...
export const LIBRARY_PACKAGES: LibraryPackage[] = [
  ...
  { id: "adafruit-busio", name: "Adafruit BusIO", author: "Adafruit", version: "1.16.1", description: "Bus I/O abstraction (I²C / SPI) used by Adafruit drivers.", topic: "Display", type: "Recommended", stars: 412, headers: ["Adafruit_BusIO_Register.h"] },
